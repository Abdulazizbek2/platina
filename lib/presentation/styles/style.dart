...
class Style {
  ...
  static const Color lightGrey2 = Color(0xffF8F8FF);

  //text colors
  static const Color greenText = Color(0xff2DA85B);
  static const Color inkText = Color(0xffA940FF);
  static const Color blueText = Color(0xff003096);
  static const Color orangeText = Color(0xffFF7D25);
  ...
  static const Color grey2Text = Color(0xff737C98);
  ...
  static const Color coursorColor = Color(0xff1072C8);
  ...
  static const Color darkBlue = Color(0xFF1D3068);
